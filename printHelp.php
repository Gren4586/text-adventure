...
// Display Help Text
function printHelp(){
 $commands=["help", "look around", "go", "put on glasses", "take off glasses", "put on contacts", "take off contacts", "eat", "drink water", "cook", "pee", "pick mushrooms", "move cupboard", "search safe"];
