...
// One Turn
function gameRound(){
    global $rounds_left, $location, $wearing_glasses, $wearing_contacts, $has_mushrooms, $moved_cupboard, $has_soup, $is_hungry, $needs_to_pee, $drank_toilet_water;
 ...
 //Read Command And Respond
    ...
    switch ($cmd) {
       ...
       case "drink water":
            ...
            break;
        case "search toilet":
            if ( $location === "bathroom" && $drank_toilet_water) {
            	echo "The familiar toilet contains an amazing secret. The bowl is filled with delicious water, but in the tank: the golden mouse statuette. The mouse's nose seems to follow you as you move. The mouse is beautiful! You love it! You're never going to sell it! Forget Great-Aunt Natasha's emu farm!\nYOU LOSE THE GAME!!!\n\n";
            $rounds_left = 1;
